...
for (optPartMethod in c("tree", "ldag", "part")){
  ...
  cat("No parents:\n")
  print(usrDAGcorescore(4, integer(0), ncol(dag), scorepar))
  cat("One parent:\n")
  print(usrDAGcorescore(4, 2, ncol(dag), scorepar))
  
  cat("Both parents:\n")
  print(usrDAGcorescore(5, 2:3, ncol(dag), scorepar))
}
...
for (optPartMethod in c("ldag", "tree")) {
  cat("\n", optPartMethod, "\n")
  scorepar$optPartMethod <- optPartMethod
  scorepar$lookup[[optPartMethod]] <- list()
  res[[optPartMethod]] <- try(sampleBN(scorepar, algo = "orderIter", verbose = T, hardlimit = 3))
  ls.str(scorepar$lookup)
}
