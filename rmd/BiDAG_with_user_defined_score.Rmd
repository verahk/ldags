...
### Result of `optimize_CSI_structure`:
The function returns the optimal partition and each parts contribution to the score of the local distribution.
```{r}
